...
# V10 — Audit et corrections

Voir `docs/V10-AUDIT-A-Z.md` pour la matrice fonctionnelle complète.
La V10 conserve PayDunya, supprime tout besoin de SMS/OTP, protège les routes privées,
simplifie le dashboard d'accueil et affiche les projets publiés sur l'accueil et `/projects`.
